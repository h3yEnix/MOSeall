    ...
    <form method="post" action="<?php echo $this->app->link(['controller' => 'comment', 'task' => 'save']); ?>">
        ...
        <?php elseif ($active_author instanceof CommentAuthorFacebook) : ?>
            <div class="uk-margin">
                ...
                - <a class="facebook-logout" href="<?php echo $this->app->link(['controller' => 'comment', 'task' => 'facebooklogout', 'item_id' => $item->id]); ?>"><?php echo JText::_('Logout'); ?></a>
            </div>
        <?php elseif ($active_author instanceof CommentAuthorTwitter) : ?>
            <div class="uk-margin">
                <?php echo JText::_('Logged in as') . ' ' . $active_author->name . ' (' . JText::_('Twitter') . ')'; ?>
                - <a class="twitter-logout" href="<?php echo $this->app->link(['controller' => 'comment', 'task' => 'twitterlogout', 'item_id' => $item->id]); ?>"><?php echo JText::_('Logout'); ?></a>
            </div>
